...
type OptionsConfiguration struct {
	...
	AckedNotifications      []string `xml:"ackedNotification" json:"ackedNotifications"`
...
func (orig OptionsConfiguration) Copy() OptionsConfiguration {
	...
	c.AckedNotifications = make([]string, len(orig.AckedNotifications))
	copy(c.AckedNotifications, orig.AckedNotifications)
	return c
}
